...
import { Rect, Circle, Grid, Ellipse, Line, ConvexPolygon, Scale9Grid, Bone, BezierPath, EndClipShape, EmptyShape } from "./shapes";
...
export class SpriteFactory {
    ...
    public static emptyShape: IShape = new EmptyShape();
